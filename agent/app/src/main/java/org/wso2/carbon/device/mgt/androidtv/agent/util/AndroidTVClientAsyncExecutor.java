 ...
 *
 */
package org.wso2.carbon.device.mgt.androidtv.agent.util;
...
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.AccessTokenInfo;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.AndroidConfiguration;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.AndroidSenseManagerService;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.ApiApplicationKey;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.ApiApplicationRegistrationService;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.ApiRegistrationProfile;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.OAuthRequestInterceptor;
import org.wso2.carbon.device.mgt.androidtv.agent.util.dto.TokenIssuerService;
...
public class AndroidTVClientAsyncExecutor extends AsyncTask<String, Void, Map<String, String>> {
    ...
    public AndroidTVClientAsyncExecutor(Context context) {
    ...
    private SSLSocketFactory getTrustedSSLSocketFactory() {
        try {
            ...
            Log.e(AndroidTVClientAsyncExecutor.class.getName(), "Invalid Certificate");
            return null;
        }
