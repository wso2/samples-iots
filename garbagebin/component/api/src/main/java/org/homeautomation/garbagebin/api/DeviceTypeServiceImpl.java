...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response getSensorStats(@PathParam("deviceId") String deviceId, @PathParam("sensorName") String sensorName,
        ...
        switch (sensorName) {
            ...
            case DeviceTypeConstants.STREAM_HUMIDITY:
                ...
                break;
            case DeviceTypeConstants.STREAM_GARBAGELEVEL:
                sensorTableName = DeviceTypeConstants.GARBAGELEVEL_EVENT_TABLE;
                break;
            default:
    ...
    public Response getAllDevices() {
        try {
            ...
            Device[] devices = garbagebinDevices.toArray(new Device[]{});
