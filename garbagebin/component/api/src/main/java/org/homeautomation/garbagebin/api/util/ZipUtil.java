...
package org.homeautomation.garbagebin.api.util;
...
public class ZipUtil {
    ...
    private static final String BROKER_HOST = "${mqtt.broker.host}";
    ...
    public ZipArchive createZipFile(String owner, String deviceType, String deviceId, String deviceName,
        ...
        try {
            ...
            String httpsServerEP = org.wso2.carbon.core.util.Utils.replaceSystemProperty(HTTPS_PROTOCOL_URL);
            String httpServerEP = org.wso2.carbon.core.util.Utils.replaceSystemProperty(HTTP_PROTOCOL_URL);
            String mqttEndpoint = org.wso2.carbon.core.util.Utils.replaceSystemProperty(DEFAULT_MQTT_ENDPOINT);
            String serverIp = org.wso2.carbon.core.util.Utils.replaceSystemProperty(BROKER_HOST);
            String mqttPort = org.wso2.carbon.core.util.Utils.replaceSystemProperty(MQTT_PORT);
            ...
            if (serverIp.contains(LOCALHOST)) {
                serverIp = serverIp.replace(LOCALHOST, iotServerIP);
            }
    ...
    private ZipArchive getSketchArchive(String templateSketchPath, Map contextParams, String zipFileName)
