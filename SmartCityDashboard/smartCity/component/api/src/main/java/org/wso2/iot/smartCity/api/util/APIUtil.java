...
package org.wso2.iot.smartCity.api.util;
...
public class APIUtil {
    ...
    /**
     * Create user role for places.
     *
     * @param role : Role that need to be created
     * @throws UserStoreException User Store Exception
     */
    public static void addRolesForPlaces(String role) throws UserStoreException {
    ...
    /**
     * Create device groups for place and assign the given list of devices.
     *
    ...
    public static void createAndAddGroups(String groupName, String role, String description) throws DeviceTypeException {
        try {
            ...
            placeGroup = new DeviceGroup();
            placeGroup.setOwner(PrivilegedCarbonContext.getThreadLocalCarbonContext().getUsername());
            placeGroup.setName(groupName);
            placeGroup.setDescription(description);
            groupManagementProviderService.createGroup(placeGroup, role,
                                                       new String[] { DeviceTypeConstants.REALTIME_ANALYTICS_PERMISSION });
            placeGroup = groupManagementProviderService.getGroup(groupName);
            groupManagementProviderService
                    .manageGroupSharing(placeGroup.getGroupId(), new ArrayList<>(Arrays.asList(role)));
