...
function onRequest(context) {
	...
	var websocketEndpointForStream2 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.TEMPERATURE/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
	return {
		"device": device,
