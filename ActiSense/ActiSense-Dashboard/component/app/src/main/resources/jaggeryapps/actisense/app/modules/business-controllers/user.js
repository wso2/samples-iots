...
var userModule = function () {
    ...
    publicMethods.getUIPermissions = function () {
        ...
        if (publicMethods.isAuthorized("/permission/admin/device-mgt/devices/enroll/senseme")) {
            permissions["ADD_DEVICE_SENSEME"] = true;
        }
        if (publicMethods.isAuthorized("/permission/admin/device-mgt/devices/enroll/alertme")) {
            permissions["ADD_DEVICE_ALERTME"] = true;
        }
