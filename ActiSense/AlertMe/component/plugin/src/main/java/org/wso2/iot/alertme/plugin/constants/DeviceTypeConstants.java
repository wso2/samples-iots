...
package org.wso2.iot.alertme.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "alertme";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "alertme_DEVICE_ID";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/alertme/+/worndetector";
