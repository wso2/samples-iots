...
package org.homeautomation.androidtv.plugin.impl.util;
...
/**
 * Contains utility methods used by androidtv plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.homeautomation.androidtv.plugin.impl.util.DeviceTypeUtils.class);
