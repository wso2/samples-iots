 ...
 * under the License.
 */
package org.wso2.iot.mqttsample.mqtt.transport;
...
public abstract class MQTTTransportHandler implements MqttCallback, TransportHandler<MqttMessage> {
    ...
    protected MQTTTransportHandler(Context context) {
        ...
        this.clientId = deviceId + ":" + DeviceConstants.DEVICE_TYPE;
        this.subscribeTopic = DeviceConstants.TENANT_ID + "/" + DeviceConstants.DEVICE_TYPE + "/" +
                deviceId + DeviceConstants.SUBSCRIBE_TOPIC_SUFFIX;
        this.clientWillTopic = DISCONNECTION_WILL_TOPIC_PREFIX + DeviceConstants.DEVICE_TYPE;
