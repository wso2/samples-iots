...
package org.homeautomation.androidtv.plugin.constants;
...
public class DeviceTypeConstants {
    ...
    public final static String SENSOR_TYPE1 = "s1";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/androidtv/+/s1";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.s1";
