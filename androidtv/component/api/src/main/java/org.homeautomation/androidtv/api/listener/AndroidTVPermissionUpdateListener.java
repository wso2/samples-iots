 ...
 */
package org.homeautomation.androidtv.api.listener;
...
public class AndroidTVPermissionUpdateListener implements ServletContextListener {

    private static Log log = LogFactory.getLog(AndroidTVPermissionUpdateListener.class);
