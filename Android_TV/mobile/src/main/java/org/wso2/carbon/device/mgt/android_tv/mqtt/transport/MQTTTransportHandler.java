 ...
 * under the License.
 */
package org.wso2.carbon.device.mgt.android_tv.mqtt.transport;
...
public abstract class MQTTTransportHandler implements MqttCallback, TransportHandler<MqttMessage> {
    ...
    protected MQTTTransportHandler(Context context) {
        ...
        this.clientId = deviceId + ":" + TVConstants.DEVICE_TYPE;
        this.subscribeTopic = LocalRegistry.getTenantDomain(context)+ "/" + TVConstants.DEVICE_TYPE + "/" +
                deviceId + "/command/#";
        this.clientWillTopic = DISCONNECTION_WILL_TOPIC_PREFIX + TVConstants.DEVICE_TYPE;
